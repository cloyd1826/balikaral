...
class Layout extends Component {
  ...
  fetchSingle(examType){
    ...
    apiRequest('get', `/generated-exam/exam-count?examType=${examType._id}&examiner=${this.props.location.state.id}`, false, this.props.token)
        .then((res)=>{
            if(res.data){
        ...
        <div>
	        ...
	        <Grid.X>
	            ...
	            {this.state.reportExamType.map((attr, index)=>{
				    ...
				    return (
				    	<Grid.Cell key={index} large={6} medium={6}  small={12}>
