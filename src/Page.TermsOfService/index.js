    ...
    return (
      ...
      <NavBar />
        <div className='tos-container privacy-policy'>
          <h1 className="privacy-policy-title">Terms of Service ("Terms")</h1>
          <div className="privacy-policy-content">
            ...
            <p>Our Service may contain links to third- party web sites or services that are not owned or controlled by Balikaral.</p>
            <p>Balikaral has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that Balikaral shall not
            be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services.</p>
