...
class Pagination extends Component {
    ...
    render() {
       ...
       const RenderPagination = () => {
        ...
        let lastPage = this.state.pageCount
          ...
          <div className='pagination'>
            {
              ...
              return (
                <li key={number}><div onClick={(e)=>{this.props.changePage(number)}} className={this.state.currentPage === number ? 'current' : 'pagination-button'} >{number}</div></li>
              )
              })
            }
          </div>
             ...
             return (
                <nav>
                    <ul className="pagination">
                        <li onClick={(e)=>{this.props.changePage((this.state.currentPage !== 1 ? this.state.currentPage - 1 : 1 ))}} className="pagination-previous"><i className='la la-angle-double-left' /></li>
                        ...
                        <li onClick={(e)=>{this.props.changePage((this.state.currentPage === lastPage ? lastPage : this.state.currentPage + 1 ))}} className="pagination-next"><i className='la la-angle-double-right' /></li>
                    </ul>
                    </nav>
                )
            } else if (this.state.currentPage > 4 && this.state.currentPage <= this.state.pageCount - 4) {
                    return (
                      <nav>
                        <ul className="pagination">
                            <li onClick={(e)=>{this.props.changePage((this.state.currentPage !== 1 ? this.state.currentPage - 1 : 1 ))}} className="pagination-previous"><i className='la la-angle-double-left' /></li>
                ...
                }else if (this.state.currentPage >= this.state.pageCount - 3) {
                    return (
                     <nav>
                            <ul className="pagination">
                                <li onClick={(e)=>{this.props.changePage((this.state.currentPage !== 1 ? this.state.currentPage - 1 : 1 ))}} className="pagination-previous"><i className='la la-angle-double-left' /></li>
