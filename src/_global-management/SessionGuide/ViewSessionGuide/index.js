                ...
                <div className='element-container'>
                  <div className='title-text-container hide-on-large-x'>
                    ...
                    <div className='title-action'>
                      ...
                      <Link to={
                          (this.props.role === 'Administrator' ? '/admin/teachers/session-guide/list/all' : '')
                          + (this.props.role === 'Teacher' ? '/teacher/management/session-guide/list/teachers' : '')
                          + (this.props.role === 'Learner' ? (this.props.hadPreTest ?  '/learner/session-guide/list/learner' :  '/learner-start/session-guide/list/learner' ) : '')
                           }>
