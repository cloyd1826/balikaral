              ...
              {this.state.isActive ? 
                <div className='action-container'>
                 ...
                 <Link to={{ 
                   ...
                   { this.props.match.params.type === 'self' || (this.props.match.params.type === 'all' && this.props.role === 'Administrator') ?
                    <div className='action' onClick={()=>{this.props.toggleDelete('/session-guide-management/delete/' + this.props.data._id)}}>
...
const LayoutSessionGuide = connect(mapStateToProps)(Layout)
const ListSessionGuide = withRouter(LayoutSessionGuide)
