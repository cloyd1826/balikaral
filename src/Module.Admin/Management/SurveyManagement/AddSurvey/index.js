...
class Layout extends Component {
  ...
  handleSubmit(e){
    ...
    this.formMessage('Saving Data', 'loading', true, true)
  	...
  	apiRequest('post', `/survey-management?userId=${this.props.user.id}`, data, this.props.token)
  		.then((res)=>{
        console.log(res)
          this.clearData()
        			...
        			<Grid.Cell large={12}  medium={12} small={12}>
        				<div className='element-container'>
        					<div className='title-text-container  hide-on-large-x'>
        						<div className='title'>Survey Management > Add</div>
...
const AddSurveyManagement = connect(mapStateToProps)(Layout)
export default AddSurveyManagement