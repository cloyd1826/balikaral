...
class Layout extends Component {
  ...
  handleSubmit(e){
    ...
    apiRequest('put', `/learning-strand-sub/update/${this.props.location.state.id}?userId=${this.props.user.id}`, data, this.props.token)
        .then((res)=>{
                    ...
                    <Grid.Cell large={12}  medium={12} small={12}>
                        <div className='element-container'>
                            <div className='title-text-container hide-on-large-x'>
                                <div className='title'>Lesson Management > Edit</div>
